...
function ReactPdfPreview({ viewerUrl }) {
  ...
  return (
    <>
      <div className="flex flex-wrap items-center gap-2 border-b border-primary/10 bg-primary/5 px-4 py-3">
        {pageCount > 0 && (
          <p className="mr-auto text-xs font-semibold text-primary/55">
