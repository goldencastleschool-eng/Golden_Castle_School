...
function TeacherSettings() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await API.put("/auth/teacher/password", {
  ...
  return (
    <div className="px-6 py-10 lg:px-12">
      ...
      <div className="mb-8">
        ...
        <h2 className="text-4xl font-extrabold text-secondary">Settings</h2>
      ...
      <section className="rounded-[2rem] bg-secondary p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-7 space-y-5">
          ...
          <button
            type="submit"
            disabled={saving}
            className="flex w-full cursor-pointer items-center justify-center rounded-2xl bg-button px-5 py-4 font-bold text-secondary shadow-xl transition-all duration-300 hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-70"
          >
