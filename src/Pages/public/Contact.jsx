       ...
       <section className="relative w-full bg-background overflow-hidden py-10 px-5 sm:px-8 lg:px-16">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                  ...
                  <div className="text-center mb-8">
                    ...
                    <p className="text-secondary/70 mt-6 max-w-2xl mx-auto text-lg leading-relaxed">
                      We would love to hear from you. Reach out to us for
                      admissions, inquiries, or any information about Golden
                      Castle International School.
                    </p>
                  </div>
